...
import lk.ijse.elitedrivingschoolmanagementormcoursework.util.AuthUtil;
import lk.ijse.elitedrivingschoolmanagementormcoursework.dto.Roles;
...
public class DashboardPageController implements Initializable {
    ...
    public void btnInstructorOnAction(ActionEvent actionEvent) {
        navigateTo("/view/InstructorsManagePage.fxml");
    }
