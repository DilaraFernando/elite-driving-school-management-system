package lk.ijse.elitedrivingschoolmanagementormcoursework.bo.util;

import lk.ijse.elitedrivingschoolmanagementormcoursework.dto.*;
import lk.ijse.elitedrivingschoolmanagementormcoursework.entity.*;
...
public class EntityDTOConverter {
    ...
    public PaymentDTO getPaymentsDTO(Payments payments){
    ...
    public Payments getPaymentsEntity(PaymentDTO dto){
    ...
    public StudentCourseDetailsDTO getStudentCourseDetailsDTO(StudentsCourseDetails studentCourseDetails){
    ...
    public StudentsCourseDetails getStudentCourseDetailsEntity(StudentCourseDetailsDTO dto){
        StudentsCourseDetails studentCourseDetails=new StudentsCourseDetails();
        Students students=new Students();
        Course course=new Course();
